...
public static class SpriteTransformer
{
    ...
    public static ISprite Overlay(this ISprite sprite, ISprite other, Point destination) 
        => new OverlayedSprite(sprite, other, destination);
    ...
    public static ISprite Greyscale(this ISprite sprite) 
        => new GreyscaleSprite(sprite);
