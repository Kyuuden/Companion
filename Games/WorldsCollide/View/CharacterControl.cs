...
public partial class CharacterControl : ImageControl<Seed, Check>
{
    private readonly Size _imageSize = new Size(40, 40);

    public CharacterControl(Seed seed, CharacterSettings settings, Check character) : base(seed, settings, character)
    {
