...
internal static class DefaultSpriteSets
{
    private static readonly SpriteSetDefinition _vanillaBosses = new()
    {
        ...
        { 
            Source = SpriteSource.Other, Id = (int)Item.WeaponShopSign, 
            Transforms = 
            [
                new Pad(24,24),
                new TextOverlay(16, 16, "1"),
                new AlternateDisabledSprite(new SpriteDefinition(SpriteSource.Other, (int)Item.WeaponShopSign, [new Pad(24,24)]))
            ] 
        },
        NarsheWeaponShopMines = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.WeaponShopSign, Transforms = [new Pad(24, 24), new TextOverlay(16, 16, "1")] },
        ...
        MtZozo = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.PottedRoses, Transforms = [new Pad { Height = 28, Width = 28 }, new Resize { Width = 56, Height = 56 }] },
        ...
        SerpentTrench = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.DiveHelm, Transforms = [new Pad { Height = 20, Width = 20 }, new Resize { Height = 40, Width = 40 }] },
        ...
        OperaHouseDisruption = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Weight, Transforms = [new Pad { Height = 28, Width = 28 }, new Resize { Width = 56, Height = 56 }] },
        ...
        EsperMountain = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.WarringTriad, Transforms = [new Pad { Height = 28, Width = 28 }, new Resize { Width = 56, Height = 56 }] },
        ...
        TzenThief = new SpriteDefinition
        {
            ...
            [
                ...
                new Overlay { X=7, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Tree, Transforms = [new Crop { Y= 10, Height = 24, Width = 16}] }},
        ...
        FanaticsTowerDragon = new SpriteDefinition { Source = SpriteSource.Boss, Id = (int)Boss.CzarDragon },
        ...
        BlueDragon = new SpriteDefinition { Source = SpriteSource.Boss, Id = (int)Boss.BlueDrgn },
        DirtDragon = new SpriteDefinition { Source = SpriteSource.Boss, Id = (int)Boss.DirtDrgn },
        GoldDragon = new SpriteDefinition { Source = SpriteSource.Boss, Id = (int)Boss.GoldDrgn },
        IceDragon = new SpriteDefinition { Source = SpriteSource.Boss, Id = (int)Boss.IceDragon },
        ...
        StormDragon = new SpriteDefinition { Source = SpriteSource.Boss, Id = (int)Boss.StormDrgn },
        WhiteDragon = new SpriteDefinition { Source = SpriteSource.Boss, Id = (int)Boss.CzarDragon },
        ...
        EsperCount = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Magicite },
        ...
        ChestCount = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.LargeOpenChest },
    ...
    private static readonly SpriteSetDefinition _locationBased = new()
    {
        ...
        LeteRiver = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Raft1, Transforms = [new Resize { Width = 64, Height = 64 }] },
        ...
        {
            Source = SpriteSource.Other,
            Id = (int)Item.NarsheCobble,
            Transforms =
            [
                new Pad { Height = 32, Width = 32, HorizontalAlignment = HorizontalAlignment.Left, VerticalAlignment = VerticalAlignment.Top },
                new Overlay { X = 16, Y = 0, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.NarsheCobble } },
                new Overlay { X = 16, Y = 16,  OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.NarsheCobble } },
                new Overlay { X = 0, Y = 16,  OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.NarsheCobble } },
                new Overlay { X = 8, Y = 8,  OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.WeaponShopSign } },
        ...
        FigaroCastleEngine = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Engine },
        ...
        FloatingContinentArrival = new SpriteDefinition
        {
            ...
            [
                new Pad { Height = 32, Width = 32, HorizontalAlignment = HorizontalAlignment.Left, VerticalAlignment = VerticalAlignment.Top },
                new Overlay { X = 16, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Spitfire } },
                new Overlay { X = 8, Y = 16, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Spitfire } },
        ...
        FloatingContinentEscape = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Blackjack, Transforms = [new Resize { Width = 32, Height = 48 }] },
        ...
        DomaDreamThrone = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Sword, Transforms = [new Pad { Height = 20, Width = 20 }, new Resize { Height = 40, Width = 40 }] },
        MtZozo = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Boquet, Transforms = [new Pad { Height = 20, Width = 20 }, new Resize { Width = 40, Height = 40 }] },
        Veldt = new SpriteDefinition { Source = SpriteSource.Character, Id = (int)CharacterEx.Gau, SubId = (int)Pose.Kneel, Transforms = [new Resize { Width = 32, Height = 48 }] },
        SerpentTrench = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.DiveHelm, Transforms = [new Pad { Height = 20, Width = 20 }, new Resize { Height = 40, Width = 40 }] },
        SouthFigaroPrisoner = new SpriteDefinition { Source = SpriteSource.Character, Id = (int)CharacterEx.Celes, SubId = (int)Pose.Chained, Transforms = [new Resize { Width = 32, Height = 48 }] },
        ...
        {
            Source = SpriteSource.Other,
            Id = (int)Item.CafeTable,
            Transforms =
            [
                new Pad { Width = 48, Height = 40 },
                new Overlay { Y=8, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.CafeChair, Transforms = [new FlipHorizontal()]}},
                new Overlay { X=32, Y=8, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.CafeChair}},
            ]
        },
        DarylsTomb = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.DarylsTomb, Transforms = [new Crop {X=8, Width = 40, Height = 40 }] },
        LoneWolfChase = new SpriteDefinition 
        { 
            Source = SpriteSource.Character, 
            Id = (int)CharacterEx.LoneWolf, 
        ...
        BurningHouse = new SpriteDefinition
        {
            ...
            [
                new Pad { Height = 32, Width = 32, HorizontalAlignment = HorizontalAlignment.Left, VerticalAlignment = VerticalAlignment.Top},
                new Overlay { X = 16, OverlayedSprite = new SpriteDefinition {Source = SpriteSource.Other, Id = (int)Item.Fire2 } },
                new Overlay { X = 8, Y = 16, OverlayedSprite = new SpriteDefinition {Source = SpriteSource.Other, Id = (int)Item.Fire3 }},
                new Resize { Height = 64, Width = 64 }
            ]
        },
        EbotsRock = new SpriteDefinition { Source = SpriteSource.Character, Id = (int)CharacterEx.Hidon, SubId = (int)Pose.Stand, Transforms = [new Resize { Width = 32, Height = 48 }] },
        ...
        {
            Source = SpriteSource.Other,
            Id = (int)Item.FanaticsTowerWall,
            Transforms =
            [
                new Pad { Height = 136, Width = 80, VerticalAlignment = VerticalAlignment.Top },
                new Overlay { Y = 40, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.FanaticsTowerFloor } },
                new Overlay { Y = 48, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.FanaticsTowerWall } },
                new Overlay { Y = 88, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.FanaticsTowerFloor } },
                new Overlay { Y = 96, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.FanaticsTowerWall } },
                new Crop { Y = 24, Width = 80, Height = 88  },
                new Overlay { OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.FanaticsTowerStairs, Transforms = [new Crop { Width = 80, Height = 40, Y = 48 }] } },
                new Overlay { OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.FanaticsTowerStairs } },
                new Overlay { Y = 48, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.FanaticsTowerStairs } }
            ]
        },
        ...
        EsperMountain = new SpriteDefinition
        {
            ...
            [
                new Pad { Height = 32, Width = 32, HorizontalAlignment = HorizontalAlignment.Left, VerticalAlignment = VerticalAlignment.Top},
                new Overlay { X = 16, OverlayedSprite = new SpriteDefinition {Source = SpriteSource.Other, Id = (int)Item.WarringTriad } },
                new Overlay { X = 8, Y = 16, OverlayedSprite = new SpriteDefinition {Source = SpriteSource.Other, Id = (int)Item.WarringTriad }},
                new Resize { Height = 64, Width = 64 }
            ]
        },
        OwzersMansion = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.OwzersPainting, Transforms = [new Crop { Width = 32, Height = 32 }] },
        ZoneEater = new SpriteDefinition { Source = SpriteSource.Boss, Id = (int)Boss.ZoneEater, Transforms = [new Crop { X = 24, Width = 72, Height = 72 }] },
        UmarosCave = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.UmaroSkull, Transforms = [new Resize { Width = 32, Height = 48 }] },
        NarsheBattle = new SpriteDefinition { Source = SpriteSource.Character, Id = (int)CharacterEx.Kefka, SubId = (int)Pose.Laugh2, Transforms = [new Resize { Width = 32, Height = 48 }] },
        TzenThief = new SpriteDefinition
        {
            Source = SpriteSource.Character,
        ...
        SearchTheSkies = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Falcon },
        TritochCliff = new SpriteDefinition { Source = SpriteSource.Character, Id = (int)CharacterEx.Tritoch, SubId = (int)Pose.Stand },
        JidoorAuctionHouse1 = new SpriteDefinition
        {
            ...
            [
                ...
                new Overlay { X= 12, Y= 8, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Magicite}},
                new Resize { Width = 48, Height = 48 },
                new AlternateDisabledSprite(new SpriteDefinition
                {
                    Source = SpriteSource.Character,
        ...
        JidoorAuctionHouse2 = new SpriteDefinition
        {
            ...
            [
                new Pad { Width = 24, Height = 24 },
                new Overlay { X= 12, Y= 8, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Magicite}},
                new Overlay { X= -4, Y= 8, OverlayedSprite = new SpriteDefinition { Source = SpriteSource.Other, Id = (int)Item.Magicite}},
                new Resize { Width = 48, Height = 48 }
            ]
        },
