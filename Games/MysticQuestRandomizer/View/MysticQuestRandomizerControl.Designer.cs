...
partial class MysticQuestRandomizerControl
{
    ...
    {
            this._equipment = new FF.Rando.Companion.Games.MysticQuestRandomizer.View.EquipmentPanel();
            this._elements = new FF.Rando.Companion.Games.MysticQuestRandomizer.View.ElementsPanel();
            this._companions = new FF.Rando.Companion.Games.MysticQuestRandomizer.View.CompanionsPanel();
            this._statistics = new FF.Rando.Companion.Games.MysticQuestRandomizer.View.StatsPanel();
            this.SuspendLayout();
            // 
            // _companions
            // 
