...
public static class EventExtensions
{
    ...
    public static bool IsDragon(this Events eventBitIndex)
        => eventBitIndex switch
        {
            Events.ICE_DRAGON_DEFEATED => true,
            Events.STORM_DRAGON_DEFEATED => true,
            Events.DIRT_DRAGON_DEFEATED => true,
            Events.GOLD_DRAGON_DEFEATED => true,
            Events.SKULL_DRAGON_DEFEATED => true,
            Events.BLUE_DRAGON_DEFEATED => true,
            Events.RED_DRAGON_DEFEATED => true,
            Events.WHITE_DRAGON_DEFEATED => true,
            _ => false
        };
